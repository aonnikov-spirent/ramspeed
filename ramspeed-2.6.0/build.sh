#!/bin/sh
# this script builds RAMspeed for a particular environment detected;
...
if [ "$1" = "clean" ]; then
    echo "rm -f ramspeed temp/*.o"
    `rm -f ramspeed temp/*.o`
    exit
fi
...
case $TARGET in
    ...
    GENERIC)
	if [ ! -f temp/ramspeed.o ]; then
	echo "$CC $CFLAGS -c -o temp/ramspeed.o ramspeed.c"
	`$CC $CFLAGS -c -o temp/ramspeed.o ramspeed.c`; fi
	...
	echo "$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o"
	`$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o`
	;;

    I386_ASM)
	if [ ! -f temp/ramspeed.o ]; then
	echo "$CC $CFLAGS -D$OS -D$TARGET -c -o temp/ramspeed.o ramspeed.c"
	`$CC $CFLAGS -D$OS -D$TARGET -c -o temp/ramspeed.o ramspeed.c`; fi
	if [ ! -f temp/intmark.o ]; then
	...
	echo "$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o temp/mmxmark.o temp/mmxmem.o temp/ssemark.o temp/ssemem.o temp/cpuinfo_main.o temp/cpuinfo_ext.o"
	`$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o temp/mmxmark.o temp/mmxmem.o temp/ssemark.o temp/ssemem.o temp/cpuinfo_main.o temp/cpuinfo_ext.o`
	;;
	...
	echo "$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o temp/mmxmark.o temp/mmxmem.o temp/ssemark.o temp/ssemem.o"
	`$LD $LFLAGS -o ramspeed temp/ramspeed.o temp/intmark.o temp/intmem.o temp/fltmark.o temp/fltmem.o temp/mmxmark.o temp/mmxmem.o temp/ssemark.o temp/ssemem.o`
	;;

    ALPHA_GNU_ASM)
	if [ ! -f temp/ramspeed.o ]; then
	echo "$CC $CFLAGS -D$OS -c -o temp/ramspeed.o ramspeed.c"
	`$CC $CFLAGS -D$OS -c -o temp/ramspeed.o ramspeed.c`; fi
	if [ ! -f temp/intmark.o ]; then
